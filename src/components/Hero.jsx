  ...
  return (
    <section className="mt-16 sm:mt-24 flex flex-col-reverse sm:flex-row items-center justify-between">
      <div className="mt-8 sm:mt-0">
        <h1 className="font-bold text-4xl sm:text-7xl text-neutral-very-dark-blue text-center sm:text-left">
          More than just shorter links
        </h1>
        <p className="mt-2 text-neutral-grayish-violet w-[80%] sm:w-[60%] text-center sm:text-lg sm:text-left mx-auto sm:mx-0">
